public class SymbolTableVisitor extends ScannerVisitor {
    ...
    public SimpleNode visit(PROG node, SimpleNode data){
        for (int i = 0; node.jjtGetNumChildren; i++){
            node.jjtGetChild[i].Accept(this, null);
        }
    }
    ...
    @Override
    public SimpleNode visit(OPTIONS node, SimpleNode data){
        return null;
    }
