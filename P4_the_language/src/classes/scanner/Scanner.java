...
public static void main(String[] args) {
        if(args.length == 0) {
            String[] files = {
                "./src/resources/testFiler/prettyPrinter/NoArgumentsImport.txt"
            };
 ...
 /*@bgen(jjtree) ADD */
  ...
  static final private int[] jj_la1 = new int[71];
