...
public class DuplicationExceptionOrTest {
    ...
    @Test
    @DisplayName("Test IS DECIMAL OR Test IS DECIMAL")
    public void isOrIs() throws Exception {
        ...
        expected += "At line: rule1: test IS DECIMAL OR test IS DECIMAL\n\n";
        
        Throwable thrown = assertThrows(DuplicationException.class, () -> firstDoub.compareTypesOr( id, secondDoub, parentNode));
